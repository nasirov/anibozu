package nasirov.yv.http.parameter;
...
import nasirov.yv.data.request.RequestParameters;
...
public interface RequestParametersBuilder {
	...
	default Map<String, Map<String, String>> build() {
		...
		headers.put("DNT", "1");
		headers.put(HttpHeaders.ACCEPT, TEXT_HTML + "," + APPLICATION_XHTML_XML + "," + APPLICATION_XML + ";q=0.9,*/*;q=0.8");
