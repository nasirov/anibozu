...
public class TestUtils {
	...
	public static <T extends Collection> T getMultiSeasonsReferencesList(Class<T> collection, boolean updated)
		...
		AnimediaMALTitleReferences fairyTail1 = AnimediaMALTitleReferences.builder()
				...
				.build();
		AnimediaMALTitleReferences fairyTail2 = AnimediaMALTitleReferences.builder()
				.url(FAIRY_TAIL_ROOT_URL)
				.dataList("2")
				.firstEpisode("176")
				.titleOnMAL("fairy tail (2014)")
				.build();
		AnimediaMALTitleReferences fairyTail3 = AnimediaMALTitleReferences.builder()
				.url(FAIRY_TAIL_ROOT_URL)
				.dataList("3")
				.firstEpisode("278")
				.titleOnMAL("fairy tail: final series")
				.build();
		AnimediaMALTitleReferences fairyTail7 = AnimediaMALTitleReferences.builder()
				.url(FAIRY_TAIL_ROOT_URL)
				.dataList("7")
				.firstEpisode("1")
				.titleOnMAL("fairy tail ova")
				.build();
		AnimediaMALTitleReferences sao1 = AnimediaMALTitleReferences.builder()
				...
				.build();
		AnimediaMALTitleReferences sao2 = AnimediaMALTitleReferences.builder()
				.url(MULTI_SEASONS_TITLE_URL)
				.dataList("2")
				.firstEpisode("1")
				.titleOnMAL("sword art online ii")
				.build();
		AnimediaMALTitleReferences sao3 = AnimediaMALTitleReferences.builder()
				...
				.build();
		AnimediaMALTitleReferences sao7 = AnimediaMALTitleReferences.builder()
				.url(MULTI_SEASONS_TITLE_URL)
				.dataList("7")
				.firstEpisode("1")
				.titleOnMAL("sword art online: extra edition")
				.build();
		AnimediaMALTitleReferences none = AnimediaMALTitleReferences.builder()
				.url("anime/velikiy-uchitel-onidzuka")
				.dataList("1")
				.firstEpisode("1")
		...
		AnimediaMALTitleReferences onePunch7_2 = AnimediaMALTitleReferences.builder()
				...
				.currentMax("7")
				.build();
		AnimediaMALTitleReferences titans3ConcretizedAndOngoing = AnimediaMALTitleReferences.builder()
				.url(CONCRETIZED_AND_ONGOING_TITLE_URL)
				.dataList("3")
				.firstEpisode("13")
				.titleOnMAL("shingeki no kyojin season 3 part 2")
				.minConcretizedEpisodeOnAnimedia("13")
				.maxConcretizedEpisodeOnAnimedia("22")
				.minConcretizedEpisodeOnMAL("1")
				.maxConcretizedEpisodeOnMAL("10")
				.build();
		if (updated) {
