...
public class CommonTitleTestBuilder {
	...
	public static CommonTitle getAnimediaRegular() {
		return getRegular(REGULAR_TITLE_ANIMEDIA_URL, 1, buildEpisodeUrl(REGULAR_TITLE_ANIMEDIA_URL, 1), ANIMEDIA_EPISODE_NAME);
	}

	public static CommonTitle getAnimediaConcretized() {
		return getConcretized(CONCRETIZED_TITLE_ANIMEDIA_URL, 1, buildEpisodeUrl(CONCRETIZED_TITLE_ANIMEDIA_URL, 1), ANIMEDIA_EPISODE_NAME);
	}
	...
	public static CommonTitle getAnidubRegular() {
		return getRegular(REGULAR_TITLE_ANIDUB_URL, null, buildEpisodeUrl(REGULAR_TITLE_ANIDUB_URL, null), ANIDUB_EPISODE_NAME);
	}

	public static CommonTitle getAnidubConcretized() {
		return getConcretized(CONCRETIZED_TITLE_ANIDUB_URL, null, buildEpisodeUrl(CONCRETIZED_TITLE_ANIDUB_URL, null), ANIDUB_EPISODE_NAME);
	}
	...
	public static CommonTitle getAnimepikRegular() {
		return getRegular(REGULAR_TITLE_ANIMEPIK_URL, null, buildEpisodeUrl(REGULAR_TITLE_ANIMEPIK_URL, null), ANIMEPIK_EPISODE_NAME);
	}

	public static CommonTitle getAnimepikConcretized() {
		return getConcretized(CONCRETIZED_TITLE_ANIMEPIK_URL, null, buildEpisodeUrl(CONCRETIZED_TITLE_ANIMEPIK_URL, null), ANIMEPIK_EPISODE_NAME);
	}
	...
	public static CommonTitle getAnilibriaRegular() {
		return getRegular(REGULAR_TITLE_ANILIBRIA_URL, null, buildEpisodeUrl(REGULAR_TITLE_ANILIBRIA_URL, null), ANILIBRIA_EPISODE_NAME);
	}

	public static CommonTitle getAnilibriaConcretized() {
		return getConcretized(CONCRETIZED_TITLE_ANILIBRIA_URL,
				null,
				buildEpisodeUrl(CONCRETIZED_TITLE_ANILIBRIA_URL, null), ANILIBRIA_EPISODE_NAME);
	}
	...
	public static CommonTitle getJisedaiRegular() {
		return getRegular(REGULAR_TITLE_JISEDAI_URL, null, buildEpisodeUrl(REGULAR_TITLE_JISEDAI_URL, null), JISEDAI_EPISODE_NAME);
	}

	public static CommonTitle getJisedaiConcretized() {
		return getConcretized(CONCRETIZED_TITLE_JISEDAI_URL, null, buildEpisodeUrl(CONCRETIZED_TITLE_JISEDAI_URL, null), JISEDAI_EPISODE_NAME);
	}
	...
	public static CommonTitle getJutsuRegular() {
		return getRegular(REGULAR_TITLE_JUTSU_URL, null, buildEpisodeUrl(REGULAR_TITLE_JUTSU_URL + "/episode-1.html", null), JUTSU_EPISODE_NAME);
	}

	public static CommonTitle getJutsuConcretized() {
		return getConcretized(CONCRETIZED_TITLE_JUTSU_URL,
				null,
				buildEpisodeUrl(CONCRETIZED_TITLE_JUTSU_URL + "/episode-1.html", null), JUTSU_EPISODE_NAME);
	}
	...
	public static CommonTitle getNineAnimeRegular() {
		return getRegular(REGULAR_TITLE_NINE_ANIME_URL, null, buildEpisodeUrl(REGULAR_TITLE_NINE_ANIME_URL + "/ep-1", null), NINE_ANIME_EPISODE_NAME);
	}

	public static CommonTitle getNineAnimeConcretized() {
		return getConcretized(CONCRETIZED_TITLE_NINE_ANIME_URL,
				null,
				buildEpisodeUrl(CONCRETIZED_TITLE_NINE_ANIME_URL + "/ep-1", null), NINE_ANIME_EPISODE_NAME);
	}
	...
	public static CommonTitle getSovetRomanticaConcretized() {
		return getConcretized(CONCRETIZED_TITLE_SOVET_ROMANTICA_URL,
				null,
				buildEpisodeUrl(CONCRETIZED_TITLE_SOVET_ROMANTICA_URL + "/episode_1-subtitles", null), SOVET_ROMANTICA_EPISODE_NAME);
	}
	...
	public static CommonTitle getShizaProjectRegular() {
		return getRegular(REGULAR_TITLE_SHIZA_PROJECT_URL, null, buildEpisodeUrl(REGULAR_TITLE_SHIZA_PROJECT_URL, null), SHIZA_PROJECT_EPISODE_NAME);
	}

	public static CommonTitle getShizaProjectConcretized() {
		return getConcretized(CONCRETIZED_TITLE_SHIZA_PROJECT_URL,
				null,
				buildEpisodeUrl(CONCRETIZED_TITLE_SHIZA_PROJECT_URL, null), SHIZA_PROJECT_EPISODE_NAME);
	}
	...
	public static CommonTitle getJamClubRegular() {
		return getRegular(REGULAR_TITLE_JAM_CLUB_URL, null, buildEpisodeUrl(REGULAR_TITLE_JAM_CLUB_URL, null), JAM_CLUB_EPISODE_NAME);
	}

	public static CommonTitle getJamClubConcretized() {
		return getConcretized(CONCRETIZED_TITLE_JAM_CLUB_URL, null, buildEpisodeUrl(CONCRETIZED_TITLE_JAM_CLUB_URL, null), JAM_CLUB_EPISODE_NAME);
	}

	public static CommonTitle getJamClubNotFoundOnMal() {
		return getNotFoundOnMal(NOT_FOUND_ON_MAL_TITLE_JAM_CLUB_URL, null);
	}

	public static CommonTitle getAnythingGroupRegular() {
		return getRegular(REGULAR_TITLE_ANYTHING_GROUP_URL, null, buildEpisodeUrl(REGULAR_TITLE_ANYTHING_GROUP_URL, null), ANYTHING_GROUP_EPISODE_NAME);
	}

	public static CommonTitle getAnythingGroupConcretized() {
		return getConcretized(CONCRETIZED_TITLE_ANYTHING_GROUP_URL,
				null,
				buildEpisodeUrl(CONCRETIZED_TITLE_ANYTHING_GROUP_URL, null), ANYTHING_GROUP_EPISODE_NAME);
	}

	public static CommonTitle getAnythingGroupNotFoundOnMal() {
		return getNotFoundOnMal(NOT_FOUND_ON_MAL_TITLE_ANYTHING_GROUP_URL, null);
	}

	public static CommonTitle getRegular(String url, Integer dataList, String episodeUrl, String episodeName) {
	...
	public static CommonTitle getConcretized(String url, Integer dataList, String episodeUrl, String episodeName) {
