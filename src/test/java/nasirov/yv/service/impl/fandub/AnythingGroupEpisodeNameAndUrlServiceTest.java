 ...
 */
class AnythingGroupEpisodeNameAndUrlServiceTest extends AbstractEpisodeNameAndUrlsServiceTest<List<CommonEpisode>> {
	...
	protected void mockGetRuntimeResponse(List<CommonEpisode> runtimeExpectedResponse, CommonTitle commonTitle) {
		doReturn(Mono.just(getCommonEpisodes())).when(reactiveAnythingGroupService)
